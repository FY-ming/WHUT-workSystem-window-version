...
void SystemWindow::showEasterEgg()
{
    ...
    textEdit->setPlaceholderText("彩蛋内容...\n\n可以写一些有趣的话、祝福语、或者任何你想说的话！");
    ...
    QString defaultEasterEggText = 
        ...
        "自己留个彩蛋还怪不好意思的。\n\n"
        "但是现在，既然你发现了这个彩蛋，那就说明我还是没忍住，hhh\n"
        "感谢你认真使用这个系统！这让我感到非常开心和欣慰！\n"
        "不过我也不确定它有多好用就是了\n"
        "毕竟现在我已经将这个程序交给下一级的队员啦\n"
        "其实有很多想说的，但最后却也不知道该说些什么\n"
        "这个小应用花了我很多时间与精力，也算是我在国旗班青春的见证\n"
        "所以，当真正交接的时候，我感慨万千\n"
        "总感觉还没改好，总感觉还能完善\n"
        "但到最后，它还是就这样结束了迭代\n"
        "我希望国旗班的大家都能够在这里找到真正热爱的、渴望的、追求的\n"
        "在这里收获真正的幸福\n"
        "毕竟我大学中最大的收获就是在这里遇见了大家\n"
        "所以，希望你也一样\n"
        "═══════════════════════════════════════\n\n"
        "开发者：万明\n"
        "日期：2026年2月\n\n"
        ...
        "国旗班，没有假的！\n"
        "也不知道还有没有人知道这口号，哈哈哈\n"
        "如果有什么你想要留给下一届学弟学妹们的话，也可以藏在这里\n"
        "使用管理员模式打开这个彩蛋就可以编辑保存啦\n"
        "信息会保留在程序根目录下的data文件夹中的easter_egg.dat中\n"
        "所以不要误删咯\n"
        "对了，进入这个彩蛋的真正方法是：\n"
        "连续双击使用说明的文本5次！hhh，有缘再见！";
